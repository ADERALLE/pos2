...
extension OrderItemPatterns on OrderItem {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _OrderItem() when $default != null:
        return $default(_that.id, _that.orderId, _that.menuItemId, _that.name,
            _that.unitPrice, _that.quantity, _that.subtotal, _that.orderNotes);
      case _:
        return orElse();
    }
  }
...
class _OrderItem implements OrderItem {
  const _OrderItem(
      ...
      @JsonKey(name: 'order_notes')
      final List<OrderNote> orderNotes = const []})
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.subtotal, subtotal) ||
                other.subtotal == subtotal) &&
            const DeepCollectionEquality()
                .equals(other._orderNotes, _orderNotes));
  }
