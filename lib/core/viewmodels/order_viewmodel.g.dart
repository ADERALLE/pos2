...
final class ActiveOrdersProvider
  ...
  ActiveOrdersProvider._(
      {required ActiveOrdersFamily super.from, required String super.argument})
      : super(
          retry: null,
...
final class ActiveOrdersFamily extends $Family
    with
        $ClassFamilyOverride<ActiveOrders, AsyncValue<List<Order>>, List<Order>,
            FutureOr<List<Order>>, String> {
...
final class OrderHistoryProvider
  ...
  OrderHistoryProvider._(
      {required OrderHistoryFamily super.from, required String super.argument})
      : super(
          retry: null,
...
final class OrderHistoryFamily extends $Family
    with
        $ClassFamilyOverride<OrderHistory, AsyncValue<List<Order>>, List<Order>,
            FutureOr<List<Order>>, String> {
...
final class MyOrderHistoryFamily extends $Family
    with
        $ClassFamilyOverride<MyOrderHistory, AsyncValue<List<Order>>,
            List<Order>, FutureOr<List<Order>>, String> {
...
final class ShopOrderHistoryFamily extends $Family
    with
        $ClassFamilyOverride<ShopOrderHistory, AsyncValue<List<Order>>,
            List<Order>, FutureOr<List<Order>>, String> {
...
final class MyActiveOrdersFamily extends $Family
    with
        $ClassFamilyOverride<MyActiveOrders, AsyncValue<List<Order>>,
            List<Order>, FutureOr<List<Order>>, String> {
...
final class ShiftOrdersProvider
  ...
  ShiftOrdersProvider._(
      {required ShiftOrdersFamily super.from, required String super.argument})
      : super(
          retry: null,
...
final class ShiftOrdersFamily extends $Family
    with
        $ClassFamilyOverride<ShiftOrders, AsyncValue<List<Order>>, List<Order>,
            FutureOr<List<Order>>, String> {
  ShiftOrdersFamily._()
      : super(
          retry: null,
...
String _$cartHash() => r'117e7a3f9c7434b2f70cdbe702eb1600cb1176de';
